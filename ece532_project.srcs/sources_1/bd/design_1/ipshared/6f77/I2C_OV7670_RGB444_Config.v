...
/////////////////////	Config Data LUT	  //////////////////////////
   ...
   // modified several register value for offsets
always@(*)
begin
	case(LUT_INDEX)
	
   // SET_OV7670 + 0 	: 	LUT_DATA	= 	16'h1214;  // Register COM7;  0001 (Output QVGA), 0100 (Output RGB)
    	SET_OV7670 + 0 	: 	LUT_DATA	= 	16'h1210;  // Register COM7;  0001 (Output QVGA), 0000 (Output YUV)
    	...
    	SET_OV7670 + 6 	: 	LUT_DATA	= 	16'h3280;	//href 80
    	SET_OV7670 + 7 	: 	LUT_DATA	= 	16'h1717;	//hstart 17 
    	SET_OV7670 + 8 	: 	LUT_DATA	= 	16'h1805;	//hstop 05
    	SET_OV7670 + 9 	: 	LUT_DATA	= 	16'h1902;	//vstrt 02
    	SET_OV7670 + 10	: 	LUT_DATA	= 	16'h1a7b;	//vstop 7b
    	SET_OV7670 + 11	: 	LUT_DATA	= 	16'h030a;	//vref 03

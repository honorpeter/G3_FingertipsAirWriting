...
HD_PWD='/nfs/ug/homes-5/l/lingujia/ECE532/ece532_project/ece532_project.runs/design_1_frame_average_buffer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_frame_average_buffer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_frame_average_buffer_0_1.tcl
